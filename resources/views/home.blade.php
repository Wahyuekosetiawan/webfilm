...
@section('content')
    <div class="container py-4">
        ...
        <div class="row justify-content-center mb-5">
            <div class="col-lg-6">
                <form method="GET" action="{{ route('home') }}" id="searchForm" class="search-form">
                    <div class="input-group">
                        <input type="text" name="search" id="searchInput" class="form-control search-input border-0"
        ...
        <div class="mb-4">
            ...
            @else
                <div class="row g-4" id="movieList">
                    @foreach ($kategoris as $kategori)
                        <div class="col-6 col-md-4 col-lg-3 col-xl-2 movie-item">
                            <a href="{{ route('kategori.show', $kategori->id) }}" class="movie-card text-decoration-none">
                                <div class="card border-0 bg-transparent">
                                    <div class="poster-container">
                                        @if ($kategori->thumbnail)
                                            <img src="{{ asset('storage/' . $kategori->thumbnail) }}"
                                                alt="{{ $kategori->nama }}" class="poster-image">
                                        @else
                                    ...
                                    <div class="card-body px-0 pt-2">
                                        ...
                                        @if ($kategori->kategori)
                                            <div class="category-badge">{{ $kategori->kategori }}</div>
                                        @endif
                ...
                <!-- 🔹 Placeholder kalau hasil pencarian kosong -->
                <div id="noResult" class="text-center py-5 d-none">
                    <i class="fas fa-search text-muted mb-3" style="font-size: 3rem;"></i>
                    <p>Film yang kamu cari tidak ditemukan 😢</p>
                </div>
            @endif
        </div>
    </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const noResult = document.getElementById("noResult"); // ambil elemen placeholder
            ...
            searchInput.addEventListener("input", function() {
                ...
                // tampilkan placeholder kalau ga ada hasil
                if (anyVisible) {
